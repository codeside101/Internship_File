...
int main() {
    ...
    float nodes[7][3] = {{0,0,0},{0.866,-0.5,0},{1.732,0,0},{1.732,1,0},{0.866,1.5,0},{0,1,0},{0.866,0.5,0}
      
    };
    int triangles[6][3] = {
       {0,1,6},{1,2,6},{2,3,6},{3,4,6},{4,5,6},{5,0,6}
    };
    const char* filename = "hexagon.stl";
   
    writeSTL_ASCII(7, 6, nodes, triangles, filename);
